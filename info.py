...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002769886785 -1002185462771').split()]  # For Multiple Id Use One Space Between Each.
